...
import { ajouterContenu } from '../../queries.js';
...
const storage = multer.diskStorage({
	destination: 'public/images/contenus/',
		...
		upload(req, res, async (err) => {
			...
			try {
				...
				if (req.file) {
					...
					console.log(req.body);
					await ajouterContenu(titre, `/images/contenus/${req.file.filename}`, dimensions.width, dimensions.height, lien);
					res.status(200).json({
						msg: 'File uploaded!',
					});
				}
